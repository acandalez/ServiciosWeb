...
public class GlobalWeatherSoapProxy implements
		NET.webserviceX.www.GlobalWeatherSoap {
	...
	private void _initGlobalWeatherSoapProxy() {
		try {
			globalWeatherSoap = (new NET.webserviceX.www.GlobalWeatherLocator())
					.getGlobalWeatherSoap();
			if (globalWeatherSoap != null) {
				if (_endpoint != null)
					((javax.xml.rpc.Stub) globalWeatherSoap)
							._setProperty(
									"javax.xml.rpc.service.endpoint.address",
									_endpoint);
				else
					_endpoint = (String) ((javax.xml.rpc.Stub) globalWeatherSoap)
	...
	public void setEndpoint(String endpoint) {
		_endpoint = endpoint;
		if (globalWeatherSoap != null)
			((javax.xml.rpc.Stub) globalWeatherSoap)._setProperty(
	...
	public java.lang.String getWeather(java.lang.String cityName,
			java.lang.String countryName) throws java.rmi.RemoteException {
		if (globalWeatherSoap == null)
			_initGlobalWeatherSoapProxy();
	...
	public static void main(String[] args) {
		GlobalWeatherSoap gws = new GlobalWeatherSoapProxy();
		try {
			String tiempo = gws.getWeather("Madrid", "Spain");
